...
import 'package:mathmentalist/src/data/models/quick_calculation.dart';
  ...
  Future<void> checkResult(String answer) async {
    if (_currentState.userAnswer.length <
      ...
      if (int.parse(_currentState.userAnswer) == _currentState.answer) {
        ...
        _list.addAll(QuickCalculationRepository.getQuickCalculationDataList(
            _index ~/ 5 + 1, 1));
        _index = _index + 1;
        ...
        notifyListeners();
          ...
          _currentState.answer.toString().length) {
        if (currentScore > 0) {
          currentScore = currentScore + ScoreUtil.quickCalculationScoreMinus;
        }
      }
    }
  }
