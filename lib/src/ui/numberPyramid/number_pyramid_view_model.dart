...
import 'package:mathmentalist/src/data/models/number_pyramid.dart';
...
import 'package:mathmentalist/src/data/repository/number_pyramid_repository.dart';
...
class NumberPyramidProvider with ChangeNotifier {
  ...
  void startTimer() {
    ...
    timerSubscription = Stream.periodic(Duration(seconds: 1),
            (x) => TimeUtil.numPyramidTimeOut - x - 1 - (levelWiseTimer))
