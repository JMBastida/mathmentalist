import 'package:mathmentalist/src/data/models/magic_triangle.dart';
...
class MagicTriangleRepository {
  ...
  static getTriangleDataProviderList() {
    ...
    list.add(MagicTriangle(getMagicTriangleGrid(correctMagicTriangle['10']),
        getMagicTriangleInput(6), 10));
    list.add(MagicTriangle(getMagicTriangleGrid(correctMagicTriangle['11']),
        getMagicTriangleInput(6), 11));
    list.add(MagicTriangle(getMagicTriangleGrid(correctMagicTriangle['12']),
        getMagicTriangleInput(6), 12));
    list.add(MagicTriangle(getMagicTriangleGrid(correctMagicTriangle['18']),
        getMagicTriangleInput(6), 18));
    list.shuffle();
    return list;
  }
  ...
  static getNextLevelTriangleDataProviderList() {
    ...
    list.add(MagicTriangle(getMagicTriangleGrid(correctMagicTriangle['20']),
        getMagicTriangleInput(9), 20));
